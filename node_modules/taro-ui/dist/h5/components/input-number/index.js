...
export default class AtInputNumber extends AtComponent {
  ...
  render() {
    const { customStyle, className, width, disabled, value, type, min, max, size, disabledInput } = this.props;
    const inputStyle = {
    ...
    return <View className={rootCls} style={customStyle}>
        ...
        <Input className="at-input-number__input" style={inputStyle} type={type} value={String(inputValue)} disabled={disabledInput || disabled} onInput={this.handleInput} onBlur={this.handleBlur} />
  ...
  handleBlur = event => this.props.onBlur && this.props.onBlur(event);
